...
for x in range(0,len(l1)):
    l2.append(0)                                                #all element of l2 becomes 0 till length of l1
                       ...
                       # TESTING DATA
test=pd.read_csv("https://raw.githubusercontent.com/NotoriousR45/Disease-Prediction/main/testing.csv")              #reading csv file by pd
...
# TRAINING DATA
train=pd.read_csv("https://raw.githubusercontent.com/NotoriousR45/Disease-Prediction/main/training.csv")
...
rohitGUI = Tk()
rohitGUI.title(" Disease Prediction Based on Symptoms")
rohitGUI.configure()
...
S1En = OptionMenu(rohitGUI, Symptom1, *OPTIONS)
S1En.grid(row=7, column=2)

S2En = OptionMenu(rohitGUI, Symptom2, *OPTIONS)
S2En.grid(row=8, column=2)

S3En = OptionMenu(rohitGUI, Symptom3, *OPTIONS)
S3En.grid(row=9, column=2)

S4En = OptionMenu(rohitGUI, Symptom4, *OPTIONS)
S4En.grid(row=10, column=2)

S5En = OptionMenu(rohitGUI, Symptom5, *OPTIONS)
S5En.grid(row=11, column=2)

NameLb = Label(rohitGUI, text="")
...
t3 = Text(rohitGUI, height=2, width=30, bg="grey")
